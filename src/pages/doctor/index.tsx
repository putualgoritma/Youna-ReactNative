...
function CardMakerMenu({image, price_before, price_promo, card_title, key}:PromoProps):JSX.Element{
 ...
 <View style={[styles.card_image,{backgroundColor : '#E37AB1'}]}></View>
  <View style ={{ marginLeft : width*0.02 }}>
    <Text style={{ color : '#E37AB1', fontWeight : 'bold' }}>Nama Doktor</Text>
    <Text>Bidang Kedokteran</Text>
    <Text>Nama Klinik</Text>
    <Text>kota lokasi klinik</Text>
  </View>
...
<View>
  <TouchableOpacity style={styles.btn_filter}>
    <Text style={styles.btn_filter_text}>Filter</Text>
  </TouchableOpacity>
</View>
