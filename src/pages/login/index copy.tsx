...
<View style={{ alignItems : 'center', marginTop : height*0.05 }}>
    <TouchableOpacity onPress={()=>{navigation.navigate('Home')}} style={{ width : width*0.4, height : height*0.07,borderRadius : width*0.2 ,backgroundColor : '#E37AB1', justifyContent : 'center' }}>
